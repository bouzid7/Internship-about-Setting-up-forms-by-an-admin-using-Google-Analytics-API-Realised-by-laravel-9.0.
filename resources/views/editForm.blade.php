@extends('layout')
 <title>@yield('title','Edit form')</title>
@section('content')
<div class="row">
    <div class="col-lg-12">
        <div class="card bg-primary text-white">
            <div class="card-body">
                <h3><b>{{__("Edit Form")}}</b></h3>
            </div>
        </div>
    </div>
</div>
<hr class="border-dark">
<div  id_form_to="{{$id}}"></div>
      @php
    include('../public/'.$code.'.blade.php')
      @endphp

<script>
       $('#form-field form').prepend("<input type='hidden' name='form_code' value="{{$code}}" ")
</script>
