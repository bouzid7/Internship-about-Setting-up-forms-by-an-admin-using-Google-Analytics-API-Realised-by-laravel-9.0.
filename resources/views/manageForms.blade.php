@extends('layout')
 <title>@yield('title','build form')</title>
@section('content')
                    ...
                    <div class="card-footer">
                        <div class="w-100 d-flex justify-content-between align-items-center">
                            <div class="form-check">
                                <input class="form-check-input req-item" id="dd" type="checkbox" value="" >
                                <label class="form-check-label req-chk" for="dd">
                                 {{__(" * required")}}
                                </label>
                            </div>
...
<div class="card mt-3 mb-3 col-md-12 question-item ui-state-default" data-item="0">
    ...
    <div class="card-footer">
        <div class="w-100 d-flex justify-content-between align-items-center">
            <div class="form-check">
                <input class="form-check-input req-item" id="ee" type="checkbox" value="" >
                <label class="form-check-label req-chk" for="ee">
                    {{__(" * required")}}  
                </label>
            </div>
            <button class="btn btn-default border rem-q-item" type="button"><i class="fa fa-trash"></i></button>
